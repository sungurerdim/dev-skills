...
Three presets, each fully defined below — chosen over a wider catalog of stub entries so every listed ID is actually usable, not a name with no token file behind it.
