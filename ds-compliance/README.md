...
Single missing privacy policy or unpatched XSS can mean fines, data breaches, or store rejection. Skill audits 108 rules across 9 compliance domains with file:line precision.

**Audit web, API, CLI, and library projects against 108 rules. Security, privacy, regulatory, web security, network, architecture, performance, i18n.**
